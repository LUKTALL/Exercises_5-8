/*
 * 16b)
 * A server is a unit within a network that works to manage data and allow for centralized comminication.
 * 
 * 16a)
 * GET is used for requesting data (GETting data), while POST is for sending data (POSTing data).
 */
...
void setup() {
  ...
  wifiMulti.addAP("NameName", "Etellerandet");  
